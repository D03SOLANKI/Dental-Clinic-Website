    ...
    if (process.env.RESEND_API_KEY) {
      try {
        await resend.emails.send({
          ...
          to: email,
          subject: "Welcome to the Aura Dental Care Family!",
          html: `
            <div style="font-family: 'Outfit', sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #e2e8f0; border-radius: 12px; background-color: #ffffff; color: #1e293b;">
              ...
              <p style="font-size: 15px; line-height: 1.6; color: #475569;">
                Thank you for subscribing to the Aura Dental Care newsletter. We are thrilled to welcome you to our family.
              </p>
              <p style="font-size: 15px; line-height: 1.6; color: #475569;">
              ...
              <div style="background-color: #f8fafc; border-radius: 8px; padding: 15px; margin: 25px 0; text-align: center;">
                ...
                <a href="${process.env.NEXT_PUBLIC_SITE_URL || "https://brightsmiledental.com"}/appointments" style="background-color: #3b82f6; color: #ffffff; text-decoration: none; padding: 10px 20px; border-radius: 6px; font-weight: bold; font-size: 14px; display: inline-block;">Book an Appointment</a>
              </div>
